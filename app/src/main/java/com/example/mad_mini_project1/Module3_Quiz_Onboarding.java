...
public class Module3_Quiz_Onboarding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_module3_quiz_onboarding);
        ...
        // first question
        loadFragment(new Module3_Quiz1(), false);

        // start countdown for module 3 quiz
        startTimer();
    }

    /**
     * Fragments call this when user taps an answer.
     */
    ...
    public void goToNextFragment() {
        ...
        if (currentFragment == 1) {
            nextFragment = new Module3_Quiz2();
            currentFragment = 2;
        } else if (currentFragment == 2) {
            nextFragment = new Module3_Quiz3();
            currentFragment = 3;
    ...
    private void goToScoreScreen() {
        cancelTimer();
        Module3_score scoreFragment = new Module3_score();
        Bundle b = new Bundle();
    ...
    private void startTimer() {
        ...
        quizTimer = new CountDownTimer(timeLeftMs, 1000) {
            ...
            public void onFinish() {
                ...
                // time's up, show score with whatever they got
                goToScoreScreen();
            }
        }.start();
    }
